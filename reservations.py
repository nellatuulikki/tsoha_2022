...
def add_reservation(room_id, customer_id, check_in, check_out, guests):
    try:
        sql = """INSERT INTO reservations (room_id, customer_id, check_in, check_out, guests)
                VALUES (:room_id, :customer_id, :check_in, :check_out, :guests)"""
...
def update_available_rooms(room_id, check_in):
    try:
        sql = """UPDATE calendar 
                ...
                where room_id = :room_id and reservation_date = reservation_date"""
